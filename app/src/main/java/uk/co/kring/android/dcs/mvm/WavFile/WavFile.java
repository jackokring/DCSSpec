...
public class WavFile {
	...
	// Cannot instantiate uk.co.kring.android.dcs.mvm.WavFile directly, must either use newWavFile() or openWavFile()
	private WavFile()
	{
	...
	{
		if (ioState != IOState.READING) throw new IOException("Cannot read from uk.co.kring.android.dcs.mvm.WavFile instance");
	...
	{
		if (ioState != IOState.WRITING) throw new IOException("Cannot write to uk.co.kring.android.dcs.mvm.WavFile instance");
